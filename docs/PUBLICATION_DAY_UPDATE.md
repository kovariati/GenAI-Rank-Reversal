...
3. Create the GitHub Release and upload `GenAI-Rank-Reversal-v1.0.0-results-and-artifacts.zip` plus its `.sha256` companion.
...
Never insert placeholder publication identifiers. After release, do not silently replace scientific assets; changes require a new version and new checksums.
